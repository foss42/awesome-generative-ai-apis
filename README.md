...
| Langchain by Greg Kamradt (Data Indy) | [Link](https://www.youtube.com/playlist?list=PLqZXAkvF1bPNQER9mLmDbntNfSpzdDIU5) | Learn the Langchain framework and how to leverage its LLMs and agents to build exceptional AI applications with this comprehensive two-part cook-book. The playlist covers working with agents, using custom files, performing Q&A with PDFs, and more. |
| LangChain Series by Krish Naik | [Link](https://www.youtube.com/playlist?list=PLZoTAELRMXVORE4VF7WQ_fAl0L1Gljtar) | The LangChain Series by Krish Naik offers a comprehensive guide to building end-to-end LLM-based application projects using LangChain. It's an excellent resource for practical implementations and detailed tutorials. |
