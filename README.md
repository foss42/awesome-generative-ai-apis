...
|:-----------|:------|:------|:-------------|
| [iLoveVideoEditor](https://ilovevideoeditor.com/) | [Link](https://ilovevideoeditor.com/docs) | Y | Motion design engine for automated video production: 249 templates, JSON-to-MP4 API, SDKs, and AI agents via MCP. |
