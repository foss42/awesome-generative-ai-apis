...
| [Text-Generator.io](https://text-generator.io) | [Link](https://text-generator.io/docs) | Y | Privacy-focused API for text, vision, speech, and embedding workflows, including retrieval and semantic-search use cases. |
| [Netwrck](https://netwrck.com) | [Link](https://netwrck.com/ai-art-generator) | Y | Creative AI platform for AI chat, characters, art generation, and media tools, with image and video models available through partner API integrations. |
...
| [OpenPaths](https://openpaths.io) | [Link](https://openpaths.io/docs) | OpenAI-compatible model router for chat, image, video, music, speech, embeddings, transcription, search, and 3D workflows across 15+ providers |
| [app.nz](https://app.nz) | [Link](https://app.nz/docs) | AI agent cloud with repo-based coding agents, deploys, research search, hosted tools, and an OpenAI-compatible model gateway |
...
| [DictatorFlow](https://dictatorflow.com) | [Link](https://dictatorflow.com) | Low-latency voice dictation agent that turns speech into clean text for writing and productivity workflows |
