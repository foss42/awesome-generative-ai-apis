...
| [Suede](https://app.suedeai.xyz) | [Link](https://github.com/Suede-AI/suede-x402-acp) | Y (x402) | AI music + video generation API. Authenticates via x402 HTTP 402 payment header (USDC on Base) — agent-callable without API keys. ACP-ready commerce intent endpoint. |
