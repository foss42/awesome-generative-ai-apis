...
| Google Gemini series by Krish Naik | [Link](https://www.youtube.com/playlist?list=PLZoTAELRMXVNbDmGZlcgCA3a8mRQp5axb) | The Google gemini playlist gives a comprehensive guide to building various LLM-based application projects using Gemini Pro. |
