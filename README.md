...
| Build a Large Language Model AI Chatbot using Retrieval Augmented Generation | [Link](https://www.youtube.com/watch?v=XctooiH0moI) | This video shows how to build a large language model ai chatbot using retrieval augmented generation |
