...
|[Ximilar API](https://www.ximilar.com/) | [Link](https://docs.ximilar.com/) | Y | Offers visual AI APIs for tasks such as image recognition and product recommendation. |
|[Modzy API](https://modzy.com/) | [Link](https://docs.modzy.com/v1.0.4/docs/mlflow) | Y |Offers a platform for deploying and managing AI models, including generative models.|
