...
| [Cortex](https://cortex-rbx.github.io) | [Link](https://github.com/cortex-rbx/roblox-ai-kit) | Y | AI API built for Roblox games — talking NPCs, adaptive quests, generated content and chat moderation via one server-side request. OpenAI-compatible, paid in Robux. |
