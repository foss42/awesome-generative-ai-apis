...
| [x402 AI API](https://api.zeroreader.com) | [Link](https://api.zeroreader.com/openapi.json) | N | 29 AI models via x402 micropayments on Cloudflare Workers. Pay-per-request with USDC on Base, no API keys required. |
