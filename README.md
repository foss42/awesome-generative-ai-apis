...
| [Eden AI](https://www.edenai.co/) | [Link](https://docs.edenai.co/docs/api-settings) | Y | Eden AI allows you to orchestrate multiple AI models to fit your business needs.|
