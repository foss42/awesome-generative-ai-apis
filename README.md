...
| [PI AI](https://pi.ai/) | [Link](https://pi.ai/talk) | Y | Text based Generative AI, can handle thread based conversation with respect to previous output and voice feature for human like interation. |
